    ...
    <div>
      ...
      <Box sx={{ 
        ...
        <Container maxWidth="sm">
          ...
          {cartItems.map((item) => (
            <Card key={item.id} sx={{ display: 'flex', mb: 2, overflow: 'hidden' }}>
              <CardMedia
                component="img"
              ...
              <CardContent sx={{ flex: '1 0 auto', p: 1 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', p: 3  }}>
                  <IconButton
                    size="small"
                ...
                <Typography variant="subtitle2" sx={{ fontWeight: 'bold', position: 'absolute', top: 8, right: 8,color:'#362FFF',fontFamily:'sans-serif',backgroundColor:'white' }}>
                  {item.price} Pi
                </Typography>
              </Box>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
            <Typography variant="subtitle1">Order Fees</Typography>
